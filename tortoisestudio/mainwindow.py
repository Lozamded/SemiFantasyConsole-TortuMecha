...
from tortoisengine.cart import load_game_module, reload_game_module
from tortoisengine.export_cart import export_cart
from tortoisengine.object import load_object
from tortoisestudio.viewport import DebugEntity
from tortoisengine.game_settings import MAX_GAME_FPS, MIN_GAME_FPS, slugify_cart_name
from tortoisengine.background import save_background
from tortoisengine.gui_layer import save_gui_layer
from tortoisengine.object import save_object
from tortoisengine.pip_bar import save_pip_bar
from tortoisengine.progress_bar import save_progress_bar
from tortoisengine.script_codegen import (
    write_audio_auto_script,
    write_object_auto_script,
    write_scene_auto_script,
)
from tortoisengine.project import Project, create_project, load_project, save_project
from tortoisengine.scene import save_scene
from tortoisengine.sprite import save_sprite
from tortoisengine.tileset import save_tileset
from tortoisestudio.asset_browser import AssetBrowserPanel
from tortoisestudio.asset_drag import DraggableProjectTree
...
from tortoisestudio.new_pip_bar_dialog import NewPipBarDialog
from tortoisestudio.new_progress_bar_dialog import NewProgressBarDialog
from tortoisestudio.new_scene_dialog import NewSceneDialog
from tortoisestudio.new_sprite_dialog import NewSpriteDialog
from tortoisestudio.new_tileset_dialog import NewTilesetDialog
from tortoisestudio.object_editor import ObjectEditorWidget
from tortoisestudio.pip_bar_editor import PipBarEditorWidget
from tortoisestudio.progress_bar_editor import ProgressBarEditorWidget
...
from tortoisestudio.scene_editor import SceneEditorWidget
from tortoisestudio.sprite_editor import SpriteEditorWidget
from tortoisestudio.palette_editor import PaletteEditorWidget
from tortoisestudio.sound_editor import SoundEditorWidget
from tortoisestudio.tileset_editor import TilesetEditorWidget
from tortoisestudio.viewport import ViewportWidget
from tortoisestudio.workspace_tabs import TabKind, TabRef, WorkspaceTabs
...
def _make_debug_probe(project_root: Path, game_module):
    ...
    _entries: list[tuple[object, str]] = []  # (TortoiseObject, sys.modules key)
...
class MainWindow(QMainWindow):
    ...
    def _action_play(self) -> None:
        ...
        cmd = [sys.executable, "-m", "tortoiseplayer", str(self.project.root)]
    ...
    def _action_export_cart(self) -> None:
        ...
        QMessageBox.information(
            ...
            "Export Cart",
            f"Cart exported to:\n{cart_path}\n\n"
            f"Run: python -m tortoiseplayer {cart_path}",
        )
    ...
    def _action_build_executable(self) -> None:
        if not self.project:
            ...
            return
        from tortoisestudio.build_dialog import BuildExecutableDialog
    ...
    def _action_open_tileset(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Tortoise Tilesets (*.tortutileset)",
        )
        if path:
    ...
    def _action_open_background(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Tortoise Backgrounds (*.tortubackground)",
        )
        if path:
    ...
    def _action_open_gui_layer(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Tortoise GUI Layers (*.tortuguilayer)",
        )
        if path:
    ...
    def _action_open_progress_bar(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Tortoise Progress Bars (*.tortuprogressbar)",
        )
        if path:
    ...
    def _action_open_sprite_font(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Open Sprite Font",
            str(self.project.fonts_dir()),
            "Tortoise Sprite Fonts (*.tortuspritefont)",
        )
        if path:
