...
from tortoisengine.constants import SCREEN_HEIGHT, SCREEN_WIDTH, TILE_BLOCK
...
from tortoisengine.palette import PAINTABLE_INDICES, TRANSPARENT_INDEX, load_palette, palette_path
...
from tortoisestudio.pip_bar_strip import PipBarStripCanvas
from tortoisestudio.progress_bar_strip import ProgressBarStripCanvas
...
from tortoisestudio.scene_editor import Tool
...
class _GuiObjectCard(QWidget):
    ...
    def sync(self, inst: GuiObject, tortu_object: TortoiseObject | None) -> None:
        widgets = (
