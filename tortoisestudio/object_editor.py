...
from tortoisengine.script_codegen import write_object_auto_script
from tortoisengine.sprite import Sprite, load_sprite
from tortoisestudio.asset_drag import ObjectDropList, SpriteDropCombo
from tortoisestudio.scene_assets import list_object_paths, list_sprite_paths
...
class ObjectEditorWidget(QWidget):
    ...
    def __init__(self, project_root: Path, parent: QWidget | None = None) -> None:
        ...
        self.tortu_object: TortoiseObject | None = None
    ...
    def new_object(self, path: Path, sprite: str, name: str, animation_name: str = "idle") -> None:
        ...
        try:
            self.tortu_object = TortoiseObject.create(name, sprite, animation_name)
