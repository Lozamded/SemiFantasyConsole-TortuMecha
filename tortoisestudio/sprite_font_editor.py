...
from tortoisestudio.new_sprite_font_dialog import NewSpriteFontDialog
...
class GlyphCanvas(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.glyph: TortoiseGlyph | None = None
...
class SpriteFontEditorWidget(QWidget):
    ...
    def __init__(self, project_root: Path, parent: QWidget | None = None) -> None:
        ...
        self.sprite_font: TortoiseSpriteFont | None = None
        ...
        from tortoisestudio.font_editor import TextFontPreviewCanvas
    ...
    def new_font(self) -> None:
        ...
        if dialog.exec() != dialog.DialogCode.Accepted:
            return
        try:
            sprite_font = TortoiseSpriteFont.create(
                dialog.font_name,
                dialog.palette_name,
