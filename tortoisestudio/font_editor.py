...
from tortoisengine.palette import PAINTABLE_INDICES, list_palette_names, load_palette, palette_path
...
from tortoisestudio.new_text_font_dialog import NewTextFontDialog
from tortoisestudio.sprite_font_editor import SpriteFontEditorWidget
...
class TextFontEditorWidget(QWidget):
    ...
    def __init__(self, project_root: Path, parent: QWidget | None = None) -> None:
        ...
        self.tortu_font: TortoiseFont | None = None
    ...
    def new_font(self) -> None:
        ...
        try:
            ...
            tortu_font = TortoiseFont.create(
                dialog.font_name,
                rel_source,
