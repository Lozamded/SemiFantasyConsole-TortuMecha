...
from tortoisestudio.asset_drag import asset_path_from_mime, mime_carries_suffix
from tortoisestudio.collapsible import CollapsibleSection
from tortoisengine.project import load_project

from tortoisengine.background import Background, load_background
from tortoisengine.constants import SCREEN_HEIGHT, SCREEN_WIDTH, SPRITE_BLOCK, TILE_BLOCK
from tortoisengine.palette import TRANSPARENT_INDEX, load_palette, palette_path
...
from tortoisengine.script_codegen import write_scene_auto_script
...
from tortoisengine.gui_layer import GuiLayer, GuiTextLabel, load_gui_layer
from tortoisengine.sprite import Sprite, load_sprite
from tortoisengine.sprite_font import TortoiseSpriteFont, load_sprite_font, render_sprite_text_line
...
from tortoisestudio.tileset_editor import TilesetStripCanvas
...
class _SceneObjectCard(QWidget):
    ...
    def __init__(self, get_object_data, get_object_index=None, resolve_object_id=None, parent=None) -> None:
        ...
        # (TortoiseObject.custom_vars) — rebuilt in sync() since different
    ...
    def sync(self, inst: SceneObject, tortu_object: TortoiseObject | None) -> None:
        widgets = (
    ...
    def _sync_customvars(self, inst: SceneObject, tortu_object: TortoiseObject | None) -> None:
...
class SceneMapCanvas(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.tortu_objects: dict[str, TortoiseObject] = {}
        ...
        self.text_fonts: dict[str, TortoiseFont] = {}
        self.sprite_fonts: dict[str, TortoiseSpriteFont] = {}
    ...
    def set_context(
        ...
        *,
        ...
        text_fonts: dict[str, TortoiseFont] | None = None,
        sprite_fonts: dict[str, TortoiseSpriteFont] | None = None,
    ...
    def _get_tortu_object(self, prefab_path: str) -> TortoiseObject | None:
        if not prefab_path:
            return None
    ...
    def _get_text_font(self, rel_path: str) -> TortoiseFont | None:
        if not rel_path:
            return None
    ...
    def _get_sprite_font(self, rel_path: str) -> TortoiseSpriteFont | None:
        if not rel_path:
            return None
...
class SceneEditorWidget(QWidget):
    ...
    def __init__(self, project_root: Path, parent: QWidget | None = None) -> None:
        ...
        self._text_fonts_cache: dict[str, TortoiseFont] = {}
        self._sprite_fonts_cache: dict[str, TortoiseSpriteFont] = {}
    ...
    def _create_camera_script(self) -> None:
        ...
        if script_path.exists():
            ...
            template = (
                ...
                "from tortoisengine.constants import SCREEN_WIDTH\n\n"
                "SMOOTHING = 8.0\n\n"
                "_cam_x: float = 0.0\n"
                "_cam_y: float = 0.0\n"
                "_scene_w: int = 0\n"
