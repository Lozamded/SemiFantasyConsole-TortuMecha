...
class TortoiseObject:
    ...
    @classmethod
    def create(cls, name: str, sprite: str, animation_name: str = "idle") -> TortoiseObject:
        if not sprite:
...
def load_object(path: Path) -> TortoiseObject:
...
def save_object(obj: TortoiseObject, path: Path) -> None:
