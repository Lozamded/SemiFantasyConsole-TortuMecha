...
from tortoisengine.constants import (
    BACKGROUND_LAYERS,
    GUI_LAYERS,
    SCREEN_HEIGHT,
    SCREEN_WIDTH,
...
class SceneObject:
    ...
    # TortoiseObject.custom_vars (name -> value). Missing keys fall back to the
    # prefab's declared default — see instance_api.custom_var().
    custom_var_overrides: dict[str, object] = field(default_factory=dict)
