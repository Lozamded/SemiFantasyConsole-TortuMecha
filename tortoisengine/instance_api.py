...
TortoisePlayer, or an exported cart.
"""
...
from tortoisengine.scene import Scene, grid_columns
from tortoisengine.sprite import load_sprite
from tortoisengine.tileset import COLLISION_NONE, Tileset, load_tileset

if TYPE_CHECKING:
    from tortoisengine.gui_layer import GuiLayer
...
def request_object_hop(instance_id: str) -> None:
    ...
    e.g. a dialogue `do_action` reacting to a player choice (see
