"""Export a Tortoise project to a pre-baked .tortucart folder."""
...
from tortoisengine.background import load_background
...
from tortoisengine.cart_manifest import (
    CART_FORMAT_VERSION,
    CART_MANIFEST_NAME,
    cart_scene_key,
    tileset_manifest_key,
)
from tortoisengine.gui_layer import load_gui_layer
from tortoisengine.object import TortoiseObject, load_object
from tortoisengine.palette import load_palette, palette_path
from tortoisengine.pip_bar import load_pip_bar
from tortoisengine.progress_bar import load_progress_bar
from tortoisengine.project import Project
from tortoisengine.scene import Scene, load_scene, save_scene
from tortoisengine.sprite import load_sprite
from tortoisengine.tileset import load_tileset
...
def _collect_object_sprites(project: Project, object_path: str, plan: _ExportPlan) -> TortoiseObject:
